...
protected:
 ...
 public:
  ...
  static bool layout_helper_is_typeArray(jint lh) {
    ...
    return (juint)lh >= (juint)((unsigned long)_lh_array_tag_type_value << _lh_array_tag_shift);
  }
  static bool layout_helper_is_objArray(jint lh) {
    // _lh_array_tag_obj_value == (lh >> _lh_array_tag_shift);
    return (jint)lh < (jint)((unsigned long)_lh_array_tag_type_value << _lh_array_tag_shift);
  }
